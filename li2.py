...
class TabUI(QTabWidget):
    ...
    def tab2f(self):
        ...
        for value in Dictionary.num_of_TU:
            self.e101.addItem(value)
    ...
    def chooseElementForTM3(self):
        if Dictionary.get_key(Dictionary.el_name_tm3, self.e1_TM3.currentText()) != 0:
            pixmap = QPixmap(
                'TM3_pics/' + Dictionary.get_key(Dictionary.el_name_tm3, self.e1_TM3.currentText()) + '.png')
    ...
    def tabDf(self):
        ...
        # Создание кнопок выбора элемента
        self.l_TMD = QLabel()
        pic = QPixmap('Pics/TMD.png')
        pic = pic.scaled(50, 100, Qt.KeepAspectRatioByExpanding,Qt.SmoothTransformation)
        self.l_TMD.setPixmap(pic)
...
#Записываем строки в массив для сохранения в ТМ2
    def dataTm2(self):
        print('popal v dataTm2')
        self.enabl()
        print('srabotal enabl')
        if self.currentIndex() == 0:
            Tm2 = TabUI.TMA
            # sender = self.sender()
        ...
        if self.currentIndex() == 2:
            Tm2 = TabUI.Tm2
            print(Tm2)
            print('e1',self.e1.text())
            print('e2',Dictionary.get_key(Dictionary.fit, self.e2.currentText()))
            print('e3',self.e3.text())
            print('e4',self.e4.text())
            print('e5',self.e5.text())
            print('e6',self.e6.text())
            print('e7',Dictionary.get_key(Dictionary.condition, self.e7.currentText()))
            print('e8',Dictionary.get_key(Dictionary.characteristic_HTO, self.e8.currentText()))
            print('e9',Dictionary.get_key(Dictionary.characteristic_cover, self.e9.currentText()))
            print('e10',str(self.e101.currentText() + '.' + Dictionary.get_key(Dictionary.TU, self.e10.currentText())))
            print('e11',str(self.e111.currentText() + Dictionary.get_key(Dictionary.TVR, self.e11.currentText()) + '.' + Dictionary.splited(self.e112.text())[1]))
            print('e12',self.e12.text())
            print('e13',self.e13.text())
            print('e14',str(self.e141.currentText() + '.' + Dictionary.get_key(Dictionary.TU, self.e14.currentText())))
            print('e15',str(self.e151.currentText() + Dictionary.get_key(Dictionary.TVR, self.e15.currentText()) + '.' + Dictionary.splited(self.e152.text())[1]))
            print('e16',self.e16.text())
            print('e17',self.e17.text())
            print('e18',self.e18.text())
            print('e19', self.e19.text())
            print('e20',self.e20.text())
            print('e21',self.e21.text())
            print('e22',self.e22.text())
            print('e23',self.e23.text())
            print('e24',self.e24.text())
            print('e25',self.e25.text())
            print('e26',self.e26.text())
            print('e27',self.e27.text())
            print('e28',self.e28.text())
            print('e29',self.e29.text())
            print('e30',Dictionary.get_key(self.e302, self.e30.currentText()))
            # sender = self.sender()
            e = [self.e1.text(), Dictionary.get_key(Dictionary.fit, self.e2.currentText()), self.e3.text(), self.e4.text(), self.e5.text(), self.e6.text(), Dictionary.get_key(Dictionary.condition, self.e7.currentText()),
                 Dictionary.get_key(Dictionary.characteristic_HTO, self.e8.currentText()), Dictionary.get_key(Dictionary.characteristic_cover, self.e9.currentText()), str(Dictionary.get_key(Dictionary.num_of_TU,self.e101.currentText())+Dictionary.get_key(Dictionary.TU, self.e10.currentText())),
                 str(Dictionary.get_key(Dictionary.num_of_TU,self.e111.currentText())+Dictionary.get_key(Dictionary.TVR, self.e11.currentText())+'.'+Dictionary.splited(self.e112.text())[1]), self.e12.text(), self.e13.text(), str(Dictionary.get_key(Dictionary.num_of_TU, self.e141.currentText())+Dictionary.get_key(Dictionary.TU, self.e14.currentText())),
                 str(Dictionary.get_key(Dictionary.num_of_TU,self.e151.currentText())+Dictionary.get_key(Dictionary.TVR, self.e15.currentText())+'.'+Dictionary.splited(self.e152.text())[1]), self.e16.text(), self.e17.text(), self.e18.text(),
            ...
            print('заполнили массив е')
        elif self.currentIndex() == 3:
            Tm2 = TabUI.Tm3
            e = [Dictionary.get_key(Dictionary.el_name_tm3, self.e1_TM3.currentText()), self.e2_TM3.text(),
                 self.e3_TM3.text(), Dictionary.get_key(Dictionary.El_2, self.e4_TM3.currentText()), self.e5_TM3.text(),
                 self.e6_TM3.text(), self.e7_TM3.text(), self.e8_TM3.text(), self.e9_TM3.text(),
                 Dictionary.get_key(Dictionary.El_2, self.e10_TM3.currentText()), self.e11_TM3.text(),
                 self.e12_TM3.text(), self.e13_TM3.text(), self.e14_TM3.text(), self.e15_TM3.text(),
                 Dictionary.get_key(Dictionary.El_2, self.e16_TM3.currentText()), self.e17_TM3.text(),
                 self.e18_TM3.text(),
                 self.e19_TM3.text(), self.e20_TM3.text(), self.e21_TM3.text(), self.e22_TM3.text(),
                 self.e23_TM3.text(), Dictionary.get_key(Dictionary.TU, self.e24_TM3.currentText()),
                 Dictionary.get_key(Dictionary.TVR, self.e25_TM3.currentText()), self.e26_TM3.text(),
                 self.e27_TM3.text(),
                 self.e28_TM3.text(), Dictionary.get_key(self.e292_TM3, self.e29_TM3.currentText()),
                 self.e30_TM3.text()]
        elif self.currentIndex() == 4:
            Tm2 = TabUI.Tm4
            ...
            Tm2 = TabUI.TMD
            e = [self.e1_TMD.text(), self.e2_TMD.text(), self.e3_TMD.text(), Dictionary.get_key(Dictionary.fit, self.e4_TMD.currentText()), self.e5_TMD.text(),
    ...
    def enterTm2(self,i):
        if self.currentIndex() == 0:
            ...
            self.e101.setCurrentIndex(self.e101.findText(Dictionary.num_of_TU[str(TabUI.Tm2[9][i][0])]))
            print(10)
            self.e11.setCurrentIndex(self.e11.findText(Dictionary.TVR[str(TabUI.Tm2[10][i][1])]))
            self.e111.setCurrentIndex(self.e11.findText(Dictionary.num_of_TU[str(TabUI.Tm2[10][i][0])]))
            ...
            self.e141.setCurrentIndex(self.e14.findText(Dictionary.num_of_TU[str(TabUI.Tm2[13][i][0])]))
            print(14)
            self.e15.setCurrentIndex(self.e15.findText(Dictionary.TVR[str(TabUI.Tm2[14][i][1])]))
            self.e151.setCurrentIndex(self.e151.findText(Dictionary.num_of_TU[str(TabUI.Tm2[14][i][0])]))
            ...
            print(29)
            print(TabUI.Tm2[29][i])
            if TabUI.Tm2[29][i][1:] == '0':
                print(TabUI.Tm2[29][i][1:], 'popal')

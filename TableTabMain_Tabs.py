...
class TabUI(QTabWidget):
        ...
        try:
            ...
            for i in range(len(TabUI.Tm1)):
                if i == 0:
                    ...
                    self.code_cover.setCurrentIndex(self.code_cover.findText(Dictionary.cover[TabUI.Tm1[i][0][:2]]))
                    self.line91.setText(TabUI.Tm1[i][0][3:])
                elif i == 18:
                    if TabUI.Tm1[i][0] == '0':
    ...
    def TM3_func(self):
        ...
        self.setCurrentIndex(self.currentIndex() + 1)
        Inition.ExcelSaveLoad.my_func('TM3', TabUI.Tm3, Tab_Widget.XLS_FILE_PATH)
